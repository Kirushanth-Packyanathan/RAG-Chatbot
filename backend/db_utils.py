...
def insert_application_logs(session_id, user_query, gpt_response, model):
    """
    Insert a new log entry into the application logs table.
    """
    conn = get_db_connection()
...
def insert_document_record(filename):
    """
    Insert a new document record into the document store.
    """
    conn = get_db_connection()
    cursor = conn.cursor()
...
def delete_document_record(file_id):
    """
    Delete a document record from the document store.
    """
    conn = get_db_connection()
